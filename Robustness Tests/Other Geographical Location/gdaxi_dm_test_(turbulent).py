# -*- coding: utf-8 -*-
"""GDAXI DM_test_(turbulent).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1t_DEC4daiFVjJ0E1hat0ZE1-b7lvUWWA
"""
...
df=df[["Date", "Actuals","Forecast without PH", "Forecast with PH", "HAR", "HARX", "HASRT - PH", "HARST (week)"]]
...
dm_test(df["Actuals"], df["HASRT - PH"], df["HARST (week)"], h = 1, crit="MSE")
...
dm_test(df["Actuals"], df["HASRT - PH"], df["HARST (week)"], h = 1, crit="MAD")
...
dm_test(df["Actuals"], df["HASRT - PH"], df["HARST (week)"], h = 1, crit="QLIKE")
...
df1["HASRT - PH"]=(df1["Actuals"]-df1["HASRT - PH"])**2
...
df1["HASRT - PH"]=abs(df1["Actuals"]-df1["HASRT - PH"])
...
df1["HASRT - PH"]=(df1["Actuals"]/df1["HASRT - PH"])-np.log(df1["Actuals"]/df1["HASRT - PH"])-1
