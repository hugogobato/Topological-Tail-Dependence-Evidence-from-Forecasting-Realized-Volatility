# -*- coding: utf-8 -*-
"""S&P 500 HARST (PH).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1TgP4zsaVs_IGdt1OVsEo3YQNJygZnmtz
"""
...
train = df.iloc[int(len(df['RV'])*0.8*0.5):int(len(df['RV'])*0.8)]
...
opt_out.x=np.array([ 0.00080647,  0.07719105,  0.04556302,  0.08094145,  0.58767417,
        0.44343998,  0.47811277,  0.3627623 ,  0.52156125,  0.31368202,
        0.53108914,  0.46428893, -0.11206266])
