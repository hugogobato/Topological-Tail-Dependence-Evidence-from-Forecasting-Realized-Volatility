...
Original file is located at
    https://colab.research.google.com/drive/1YBmjEYHU6TJ2EgiUDTeUkY-llaTgsSsp
"""
...
for m in range (5):
  ...
  forecasts = fcst.cross_validation(df=train,val_size=5,static_df=AirPassengersStatic,n_windows=None, test_size=validation_length-validation_length%1,step_size=1)
...
"""INFO:lightning_fabric.utilities.seed:Global seed set to 97786335

Epoch: 150 | Inputs: 5 | MLP units: [[712, 712], [712, 712]] | Loss: 1 | Scaler Type: standard
Stack Types: ['identity', 'identity'] | Learning Rate: 1e-05 | Block: [5, 5]
RMSE: 0.0021726026478436785 | QLIKE: 0.06992332779665292
"""
